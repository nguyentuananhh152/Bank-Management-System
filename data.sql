-- 1 Client Table
CREATE TABLE IF NOT EXISTS `bank_schema`.`client` (
...
CREATE TABLE IF NOT EXISTS `bank_schema`.`login_account` (
...
-- 4 Card Table
CREATE TABLE IF NOT EXISTS `bank_schema`.`card` (
...
CREATE TABLE IF NOT EXISTS `bank_schema`.`bank_account` (
...
CREATE TABLE IF NOT EXISTS `bank_schema`.`transaction_history` (
...
CREATE TABLE IF NOT EXISTS `bank_schema`.`cardless_withdrawl` (
